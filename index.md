...
| Accelerator | bf16 PFLOPs/s | fp8 | fp4 | HBM GB | HBM TB/s | Scale-up GB/s | Domain | Scale-out GB/s | $C/W_\text{hbm}$ | $\alpha = C/W_\text{net}$ (per GPU; per ICI axis) |
| :--- | ------------: | --: | --: | --: | -------: | :-------------- | -----: | :--------------- | ---------------: | ---------------: |
...
| GB200 NVL72, per GPU (2025) | 2.5 | 5 | 10 | 186 | 8 | 900 | 72 | 50 (3,600 per rack) | 312 | 2,780 |
| GB300 NVL72, per GPU (2026) | 2.5 | 5 | 15 | 288 | 8 | 900 | 72 | 100 (7,200 per rack) | 312 | 2,780 |
| Vera Rubin NVL72, per GPU (2026) | 4 | 17.5 | 35 | 288 | 19.2 | 1,500 | 72 | 200 (14,400 per rack) | 208 | 2,700 |
| AMD MI355X (2025) | 2.5 | 5 | 10.1 | 288 | 8 | about 535 | 8 | 50 | 312 | 4,700 |
| AMD MI455X Helios, per GPU (2026) | 5 | 20.1 | 40.3 | 432 | 19.6 to 23.3 | 1,800 | 72 | 300 (21,600 per rack) | 215 | 2,800 |
